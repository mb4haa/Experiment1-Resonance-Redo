...
public class hapticfreq : MonoBehaviour
{
    ...
    void LateUpdate()
    {
        ...
        if (_hand != null)
        {
            ...
            if (device != null)
            {
                ...
                {
                    if (CalculateDistance(ThreeLevelHorizontal_freq.actualPoint.transform, this.transform) <= 0.25)
                    {
                        Debug.Log("Inside the distance");
                        Debug.Log(CalculateDistance(ThreeLevelHorizontal_freq.actualPoint.transform, this.transform));
                        _hand.controller.TriggerHapticPulse(1500);
                        //  Player.instance.rightController.TriggerHapticPulse(800);
                        //   Player.instance.leftController.TriggerHapticPulse(800);
                    }
                    else if (CalculateDistance(ThreeLevelHorizontal_freq.actualPoint.transform, this.transform) <= 0.4)
                    {
                        Debug.Log("Inside the distance");
                        Debug.Log(CalculateDistance(ThreeLevelHorizontal_freq.actualPoint.transform, this.transform));
                    ...
                    else if (CalculateDistance(ThreeLevelHorizontal_freq.actualPoint.transform, this.transform) <= 0.6)
                    {
                        Debug.Log("Inside the distance");
                        Debug.Log(CalculateDistance(ThreeLevelHorizontal_freq.actualPoint.transform, this.transform));
			   ...
			   _hand.controller.TriggerHapticPulse(0);
                        }
